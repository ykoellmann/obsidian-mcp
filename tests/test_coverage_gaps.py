...
from obsidian_mcp.tools.write import WritePermissionError

# ── write_note + read_note round-trip (B1) ────────────────────────────────────

def test_write_note_creates_file(tmp_path, vault_factory):
    vault_factory({})
    from obsidian_mcp.tools.write import write_note
...
def test_list_canvases_finds_canvas(tmp_path, vault_factory):
    ...
    from obsidian_mcp.tools.canvas import list_canvases
...
def test_read_canvas_basic(tmp_path, vault_factory):
    ...
    from obsidian_mcp.tools.canvas import read_canvas
...
def test_patch_block_ref_insert_after(tmp_path, vault_factory):
    ...
    from obsidian_mcp.tools.write import patch_note
...
def test_resolve_alias_found(vault_factory):
    ...
    from obsidian_mcp.tools.query import resolve_alias
